...
public class FlightBoardTest {
	...
	public static void main(String[] args) {
		...
		*/
		...
		t1.setStart(T1.get(Calendar.YEAR), T1.get(Calendar.MONTH), T1.get(Calendar.DATE),
				T1.get(Calendar.HOUR_OF_DAY), T1.get(Calendar.MINUTE));
		t1.setEnd(T2.get(Calendar.YEAR), T2.get(Calendar.MONTH), T2.get(Calendar.DATE),
				T2.get(Calendar.HOUR_OF_DAY), T2.get(Calendar.MINUTE));
		/*Timeslot t2=new Timeslot();
		t2.setStart(T3.get(Calendar.YEAR), T3.get(Calendar.MONTH), T3.get(Calendar.DATE),
				T3.get(Calendar.HOUR_OF_DAY), T3.get(Calendar.MINUTE));
		t2.setEnd(T4.get(Calendar.YEAR), T4.get(Calendar.MONTH), T4.get(Calendar.DATE),
				T4.get(Calendar.HOUR_OF_DAY), T4.get(Calendar.MINUTE));*/
		course1.setTime(t1);
		//course1.addTime(t2);
		course1.begin();
		list.add(course1);
