...
public class TrainScheduleApp {
	...
	private void planningUi() {
		for (int i = 0; i < this.list.size(); ++i) {
			if (this.list.get(i).getLocation().size()==
					this.list.get(i).getTime().size()+1 && this.list.get(i).resourceIsSet()
	...
	private void checkUi() {
		...
		b2.addActionListener((e) -> {
			...
			if (flag1 == false || flag2 == false) {
				...
				PlanningEntryAPIs<TrainResource> api = new PlanningEntryAPIs<TrainResource>();
				PlanningEntry c3 = api.findPreEntryPerResource(Strategy.getInstance("FindFast"), this.resource.get(j), this.list.get(i), this.list);
		...
		b3.addActionListener((e) -> {
			...
			if (flag1 == false || flag2 == false) {
				...
				PlanningEntryAPIs<TrainResource> api = new PlanningEntryAPIs<TrainResource>();
				PlanningEntry c3 = api.findPreEntryPerResource( Strategy.getInstance("FindLatest"), this.resource.get(j), this.list.get(i), this.list);
	...
	private void allocateLUi() {
		...
		b1.addActionListener((e) -> {
			...
			if (flag1 == false || flag2 == false ||  
					this.list.get(i).getLocation().size()==
					this.list.get(i).getTime().size()+1) {
				JOptionPane.showMessageDialog(null, "安排失败");
			} else {
