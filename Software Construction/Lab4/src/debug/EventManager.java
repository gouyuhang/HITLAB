 ...
 * 
 * 例如： book(1,8,10)表示添加一个在1月1日（第1天）的8点开始，10点结束的事件。 book(1, 0,
 * 1)表示在第1天的0:00-1:00的事件  book(1, 22,24)表示在第1天的22:00-24:00的事件
 * 
 * 事件的长度单位是小时，不需要考虑分钟。
 * 
 ...
 * 例如：
 * 
 * EventManager.book(1, 10, 20); // returns 1 EventManager.book(1, 1, 7); //
 * returns 1 EventManager.book(1, 10, 22); // returns 2 EventManager.book(1, 5,
 * 15); // returns 3 EventManager.book(1, 5, 12); // returns 4
