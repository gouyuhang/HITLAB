...
public class TrainBoard {
	...
	public void visualize(String location) {
		...
		JFrame jf = new JFrame(
				dateformat.format(new Date(Calendar.getInstance().getTimeInMillis())) + " " + location + "车站 出站表");
	...
	public void visualize2(String location) {
		...
		SimpleDateFormat dateformat = new SimpleDateFormat("yyyy-MM-dd HH:mm");
		JFrame jf = new JFrame(
				dateformat.format(new Date(Calendar.getInstance().getTimeInMillis())) + " " + location + "车站 进站表");
		Vector<Object> columnNames = new Vector<>();
		columnNames.add("时间");
		columnNames.add("列车号");
		columnNames.add("起点-终点");
	...
	public void visualize3(String location) {
		...
		SimpleDateFormat dateformat = new SimpleDateFormat("yyyy-MM-dd HH:mm");
		JFrame jf = new JFrame(
				dateformat.format(new Date(Calendar.getInstance().getTimeInMillis())) + " " + location + "车站 经停表");
		Vector<Object> columnNames = new Vector<>();
